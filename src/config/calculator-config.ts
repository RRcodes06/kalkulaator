...
const texts = {
  ...
  pageTitle: {
    est: 'Värbamisprotsessiga seotud tegeliku kogukulu kalkulaator',
    eng: 'Calculator for the Actual Total Cost Associated with the Recruitment Process',
  },
